<?php
	...
	class Authenticator {
		 ...
		 * @return string
		 */
		public function getQRCodeGoogleUrl(string $name, string $secret, $title = null, $params = []): string {
		 ...
		 * @param string   $secret
		 * @param string   $code
		 * @param int      $discrepancy      This is the allowed time drift in
		 *                                   30 second units (8 means 4 minutes
		 *                                   before or after)
		 ...
		 * @return bool
		 */
		public function verifyCode(string $secret, string $code, $discrepancy = 1, $currentTimeSlice = null): bool {
		 ...
		 */
		public function setCodeLength(int $length): Authenticator {
		...
		/**
		 * Get array with all 32 characters for decoding from/encoding to
		 * base32.
		 *
		 * @return array
		 */
